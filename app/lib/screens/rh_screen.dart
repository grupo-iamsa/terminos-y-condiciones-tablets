                  ...
                  child: ListView(
                    children: [
                      ...
                      ListTile(
                        contentPadding: const EdgeInsets.only(left: 30),
                        leading: Image.asset('assets/img/favicon.png'),
                        title: const Text('Aviso integral para áreas de recursos humanos', style: TextStyle(color: accentColor)),
                        onTap: () {
            ...
            child: Column(
              ...
              children: [
                const Padding(
                  ...
                  child: TitleCustome(title: 'AVISO DE PRIVACIDAD INTEGRAL PARA ÁREAS DE RECURSOS HUMANOS')
                ),
                Padding(
                    ...
                    children: [
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            const TextSpan(text: 'El tratamiento legítimo, controlado e informado de sus datos personales es de vital importancia para alcanzar los objetivos corporativos de '),
                            textBold('ETN TURISTAR LUJO, S.A. DE C.V., '),
                            const TextSpan(text: 'a través de todas las áreas del negocio reiterando nuestro compromiso con su privacidad y el derecho a la autodeterminación informativa, por lo que, en cumplimiento a lo establecido en la Ley Federal de Protección de Datos Personales en Posesión de los Particulares, ponemos a su disposición nuestro AVISO DE PRIVACIDAD.'),
                          ],
                        ),
                      ),
                    ],
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            const TextSpan(text: 'o en nuestras oficinas centrales, se hacen del conocimiento público las políticas de privacidad aplicables a los Datos Personales que nos hayan sido otorgados.'),
                          ],
                        ),
                      ),
                    ],
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const ParrafCustome(text: 'Para efectos de la divulgación y tratamiento de los Datos Personales que Usted haya divulgado o pudiera llegar a divulgar, a través de diversos medios y formas incluyendo nuestros sitios de Internet, herramientas tecnológicas, o directamente a nuestros representantes, con motivo de la relación laboral o posible relación laboral que con Usted, él Titular, se cree, así como por el uso de nuestros productos y/o servicios, así como para cualquier actividad relacionada, se considerará que el responsable es ETN TURISTAR LUJO, S.A. DE C.V., quien es una sociedad constituida de conformidad con las leyes de la República Mexicana, con domicilio de oficina central en Capital Reforma, Paseo de la Reforma número 250, Torre A, Piso 23, en la Colonia Juárez, de la Alcaldía Cuauhtémoc, Código Postal 06600, en la Ciudad de México.'),
                      RichText(
                        text: TextSpan(
                          style: const TextStyle(fontSize: 16, color: Colors.black),
                          children: [
                ...
                const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ParrafCustome(text: 'Para llevar a cabo las finalidades descritas en el presente aviso de privacidad ETN TURISTAR LUJO, S.A. DE C.V. podrá recabar y, en su caso, tratar los datos personales que a continuación se especifican, con base en la relación jurídica o no jurídica que con el Titular exista, incluyendo Datos Personales Sensibles, mismos que se detallan a continuación.'),
                      Row(
                        children: [
                          Expanded(
                            flex: 1,
                            child: Column(
                              ...
                              children: [
                                ...
                                ListItemCustome(text: '• Gustos y preferencias turísticas, deportivas, sociales, entretenimiento'),
                                ListItemCustome(text: '• Clave Única de Registro de Probación (CURP)'),
                                ListItemCustome(text: '• Registro Federal de Contribuyentes (RFC)'),
                                ListItemCustome(text: '• Número de seguridad social'),
                                ListItemCustome(text: '• Categoría de empleado y puesto'),
                                ListItemCustome(text: '• Sueldo, percepciones y deducciones'),
                                ListItemCustome(text: '• Referencias personales y familiares'),
                                ListItemCustome(text: '• Información relacionada con beneficiarios y /o dependientes económicos'),
                                ListItemCustome(text: '• Nombre del Cónyuge, y de los Padres'),
                                ListItemCustome(text: '• Fecha de Nacimiento del Cónyuge'),
                                ListItemCustome(text: '• Nombre del Padre'),
                                ListItemCustome(text: '• Nombre de la Madre'),
                                ListItemCustome(text: '• Antecedentes médicos del Titular, así como de familiares, beneficiarios y/o dependientes económicos'),
                                ListItemCustome(text: '• Resultados de evaluación Psicométrica'),
                                ListItemCustome(text: '• Resultados de evaluación Técnica'),
                                ListItemCustome(text: '• Resultados de evaluación Médica'),
                              ],
                            ), 
                          ),
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ListItemCustome(text: '• Resultados de evaluación Médica'),
                                ListItemCustome(text: '• Grupo sanguíneo'),
                                ListItemCustome(text: '• Preferencias religiosas'),
                                ListItemCustome(text: '• Constancias medicas e información de tratamientos médicos'),
                                ListItemCustome(text: '• Video grabaciones'),
                                ListItemCustome(text: '• Grado Académico e Institución que avala los estudios'),
                                ListItemCustome(text: '• Carrera/ Especialidad'),
                                ListItemCustome(text: '• Periodo escolar'),
                                ListItemCustome(text: '• Titulo (pasante, trunco, concluido)'),
                                ListItemCustome(text: '• Nombre de la última empresa en la que trabajo y la ciudad o población'),
                                ListItemCustome(text: '• Puesto que desempeñaba y periodo'),
                                ListItemCustome(text: '• Empresa subcontratada'),
                                ListItemCustome(text: '• Motivo de la contratación'),
                                ListItemCustome(text: '• Nombre de la persona a la que reemplaza'),
                                ListItemCustome(text: '• Fecha de ingreso'),
                                ListItemCustome(text: '• Puesto'),
                                ListItemCustome(text: '• Oficina'),
                                ListItemCustome(text: '• Horario de Trabajo'),
                                ListItemCustome(text: '• Información respecto al desempeño laboral.'),
                                ListItemCustome(text: '• Dirección de IP'),
                                ListItemCustome(text: '• Información URL'),
                                ListItemCustome(text: '• Cookies'),
                                ListItemCustome(text: '• Web Beacons'),
                                ListItemCustome(text: '• Unidad médica a la que pertenece'),
                                ListItemCustome(text: '• Núm. de Cuenta Bancaria'),
                                ListItemCustome(text: '• Datos de crédito Infonavit, fonacot o cualquier otro beneficio de seguridad social'),
                              ],
                            ), 
                          )
                        ],
                ...
                const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ParrafCustome(text: 'Así mismo, le informamos que en las instalaciones, sucursales y oficinas corporativas de ETN TURISTAR LUJO, S.A. DE C.V., contamos con sistema de video vigilancia y/o grabaciones de audio, por lo que, podrá ser obtenido por medio de nuestras cámaras de seguridad, imágenes y audio del Titular de Datos Personales, para fines de identificación, control y seguridad de los usuarios, proveedores y personal de ETN TURISTAR LUJO, S.A. DE C.V.'),
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ListItemCustome(text: '• Pago de beneficios, salarios y prestaciones, bonos, reembolsos, pensiones, seguros y otros.'),
                                ListItemCustome(text: '• Contratación de seguros.'),
                                ListItemCustome(text: '• Asignar herramientas de trabajo, así como, documentar y controlar la asignación de activos de cómputo y comunicaciones.'),
                                ListItemCustome(text: '• Auditorías internas.'),
                                ListItemCustome(text: '• Creación y asignación de cuenta de correo electrónico laboral.'),
                                ListItemCustome(text: '• Elaboración de directorio de la empresa.'),
                                ListItemCustome(text: '• Asignar claves y contraseñas.'),
                                ListItemCustome(text: '• Asegurar el cumplimiento de obligaciones de confidencialidad y otras obligaciones laborales y fiscales.'),
                                ListItemCustome(text: '• Verificar referencias personales y laborales.'),
                                ListItemCustome(text: '• Contactar a sus familiares, dependientes económicos y beneficiarios en caso de emergencia.'),
                                ListItemCustome(text: '• Enviar información acerca de proveedores que ofrecen productos, servicios y/o beneficios laborales.'),
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ListItemCustome(text: '• Identificación y contacto'),
                                ListItemCustome(text: '• Localización'),
                                ListItemCustome(text: '• Historial laboral'),
                                ListItemCustome(text: '• Estadísticos'),
                                ListItemCustome(text: '• De control y seguridad'),
                                ListItemCustome(text: '• Rectificar vínculo laboral'),
                                ListItemCustome(text: '• Atender cualquier queja, pregunta o comentario'),
                                ListItemCustome(text: '• Envío de notificaciones, avisos, propaganda o publicidad, información y noticias sobre nuestros productos o servicios de ETN TURISTAR LUJO, S.A. DE C.V., o sus empresas relacionadas'),
                                ListItemCustome(text: '• Crear bases de datos para fines estadísticos'),
                                ListItemCustome(text: '• Formar expedientes administrativos de empleados.'),
                                ListItemCustome(text: '• Formar expedientes médicos de empleados.'),
                                ListItemCustome(text: '• Pago y administración de nómina.'),
                              ],
                            ), 
                          ),
                        ],
                      ),
                      ParrafCustome(text: 'Asimismo el titular-usuario es responsables de la veracidad, exactitud y actualidad de los datos personales que publican en sus perfiles de redes sociales o en las redes sociales de ETN TURISTAR LUJO, S.A. DE C.V., así como el grado de difusión de su información y del acceso a la misma que por este medio permiten o autorizan a terceos a través de dichos perfiles.')
                    ],
                  )
                ),
                const Padding(
                ...
                const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ParrafCustome(text: 'Asimismo, ETN TURISTAR LUJO, S.A. DE C.V., se reserva el derecho de compartir sus Datos Personales con autoridades administrativas, judiciales o gubernamentales de cualquier tipo, en los Estados Unidos Mexicanos. '),
                      ParrafCustome(text: 'ETN TURISTAR LUJO, S.A. DE C.V., podrá transferir sus Datos Personales a asesores y prestadores de servicio de cobranza, cualquier adquirente de la empresa, compañías matrices, afiliadas o subsidiarias de, ETN TURISTAR LUJO, S.A. DE C.V., asesores profesionales externos; y otros prestadores que ofrezcan servicios, soporte técnico, tecnologías de la información y en general, cualquier tercero que actúe como encargado a nombre y por cuenta de ETN TURISTAR LUJO, S.A. DE C.V.'),
                ...
                const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ParrafCustome(text: 'ETN TURISTAR LUJO, S.A. DE C.V., recomienda al Titular que vuelva a leer con regularidad este documento, de forma que se mantenga siempre informado sobre eventuales modificaciones.'),
                      ParrafCustome(text: 'Las alteraciones o modificaciones al presente Aviso de Privacidad se volverán efectivas inmediatamente después de su publicación en nuestras oficinas centrales, sin perjuicio del uso de algún otro medio para que ETN TURISTAR LUJO, S.A. DE C.V., de las mencionadas publicaciones.'),
                ...
                const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ParrafCustome(text: 'En caso de haber solicitado el derecho de Oposición al tratamiento de Datos Personales ETN TURISTAR LUJO, S.A. DE C.V., considerará lo siguiente:'),
                ...
                const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ParrafCustome(text: 'Una vez que los datos hayan sido cancelados, ETN TURISTAR LUJO, S.A. DE C.V., conservará un mes más los datos personales del Titular, para fines de aclaraciones y preparación para la supresión. Una vez vencido este plazo, ETN TURISTAR LUJO, S.A. DE C.V., bloquearan de manera definitiva los datos personales del titular, no teniendo oportunidad de localización ni contacto con el titular. Si el titular llegare a realizar otro acto con ETN TURISTAR LUJO, S.A. DE C.V., deberá de iniciarlo como si la relación nunca hubiera existido.'),
                      ParrafCustome(text: 'Lo anterior, observando lo señalado en las Políticas de Privacidad para efectos de conservar información por ministerio de ley o de autoridad.'),
                      ParrafCustome(text: 'no puedan ser cancelados y/o suprimidos por ministerio de ley o contractual, serán bloqueados de los fines a los que eran sometidos, hasta que se pueda suprimir. Durante dicho periodo, los datos personales no podrán ser objeto de tratamiento mayor a la conservación y resguardo.'),
                    ],
                  )
                ),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const ParrafCustome(text: 'El consentimiento podrá ser revocado en cualquier momento sin que se le atribuyan efectos retroactivos.'),
                      RichText(
                        text: TextSpan(
                          style: const TextStyle(fontSize: 16, color: Colors.black),
                          children: [
                            const TextSpan(text: 'Para revocar el consentimiento el Titular debe de enviar una Solicitud por escrito al correo '),
                            textLink('atn_clientes@etn.com.mx '),
                      ...
                      const ListItemCustome(text: '• Los documentos que acrediten la identidad del Titular, IFE y/o PASAPORTE, o en su caso, la representación legal del titular.'),
                      ...
                      const ListItemCustome(text: '• Documentos que acrediten que la relación jurídica que sostiene con ETN TURISTAR LUJO, S.A. DE C.V., ha terminado.'),
